export default {
  ...
  INTRODUCTION: {
    ...
    DUTY: {
      ...
      WARNING: {
        ...
        CANNOT_RESTORE: 'password perdute, frasi segrete o fondi rubati non potranno essere ripristinati dal team PHANTOM , dai Delegati e da nessun altro.'
      },
    ...
    RESPONSIBILITY: {
      ...
      BACKUP: {
        ...
        OPTIONS: 'È possibile scriverla su carta spessa e archiviarne più copie in posti sicuri. È inoltre possibile memorizzarla su un\'unità flash crittografata. In alternativa, è possibile utilizzare un dispositivo hardware USB Ledger Nano S, disponibile su Ledger.com, per archiviare e accedere ai fondi e all\'PHANTOM Desktop Wallet. Puoi collegare il tuo Ledger Nano S al tuo computer e accedere alla blockchain PHANTOM senza dover inserire la tua frase segreta.'
      },
  ...
  PAGES: {
    ...
    WALLET_EXCHANGE: {
      CHANGELLY_TERMS: {
        TITLE: 'Acquista {ticker} direttamente dall\'PHANTOM Desktop Wallet tramite la nostra integrazione di Changelly',
